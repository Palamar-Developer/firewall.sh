#!/bin/bash
#Um exemplo de script de shell de firewall 
IPT="/sbin/iptables"
SPAMLIST="blockedip"
...
#Tráfego ilimitado para loopback
$IPT -A INPUT -i lo -j ACCEPT
$IPT -A OUTPUT -o lo -j ACCEPT
 
#DROP todo o tráfego de entrada
$IPT -P INPUT DROP
$IPT -P OUTPUT DROP
$IPT -P FORWARD DROP
...
if [ -f "${BLOCKEDIPS}" ];
then
#cria uma nova lista de iptables
$IPT -N $SPAMLIST
